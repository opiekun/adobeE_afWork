...
class Sync extends \Magento\Framework\App\Helper\AbstractHelper implements SyncInterface
{
    ...
    const CUSTOMER_GROUP_IDS_IGNORE = 'eyehubspot/settings/ignore_customer_group_ids';
    ...
    /**
     * Get customer group ids to ignore
     * @return mixed
     */
    public function getCustomerGroupIdsIgnore()
    {
        return $this->scopeConfig->getValue(self::CUSTOMER_GROUP_IDS_IGNORE, ScopeInterface::SCOPE_STORE);
    }
}
