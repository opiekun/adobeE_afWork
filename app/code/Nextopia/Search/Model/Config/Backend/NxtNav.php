 ...
 */
class NxtNav extends \Magento\Framework\App\Config\Value
{
    /**
    ...
    public function beforeSave()
    {
        ...
        if ($value == "1" && !Data::isClientOneLineCodeAvailable($client_id)) {
            $msg = __('Please enter a valid Public Client Id to enable the Navigation. Refer the installation document on how to get the Valid Public Client id');
